...
class DashboardController extends Controller
{
    ...
    public function show()
    {
        ...
        $datosRequestPortalLog['detalle'] = "El usuario con el identificador N° $portalUserId ha entrado en la pantalla de procesos disciplinarios";
        ...
        return Datatables::of($informacion)
            ...
            ->addColumn('informacion', function ($informacion) {
                ...
                $btn = '<div class="row">
                        ...
                        <div class="row">
                                <div class="col-md-6" style="text-align: left"> <b style="color: #939393;"> Tipo de proceso: </b> <span style="color: #939393;">' . $informacion->nombre  . '</span> </div>
    ...
    private function consultarProcesosDisciplinariosUsuario($numeroDocumento, $tipoDocumento)
    {
        ...
        $informacionProcesos = DB::select("SELECT DISTINCT PD.RADICADO, PD.VIGENCIA, TO_CHAR(PD.CREATED_AT, 'DD/MM/YYYY') AS CREATED_AT, MTP.NOMBRE, case when PD.ESTADO = 1 then 'ACTIVO' when PD.ESTADO = 0 then 'INACTIVO' else 'NO DEFINIDO' END AS estado, PD.UUID
