...
class NotificationsController extends Controller
{
    ...
    public function show()
    {
        ...
        $datosRequestPortalLog['detalle'] = "El usuario con el identificador N° $portalUserId ha entrado en la pantalla de notificaciones";
        ...
        return Datatables::of($informacion)
            ...
            ->addColumn('informacion', function ($informacion) {
                ...
                $btn = '<div class="row">
                            ...
                            <div class="col-md-4" style="text-align: left; margin-top: 5px;"> <b style="color: #939393;"> Estado: </b> <span style="color: #939393;">' . $informacion->estado . ' </span> </div>
                        </div>';
