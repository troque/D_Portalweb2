...
class AuthenticatedSessionController extends Controller
{
    ...
    public function store(LoginRequest $request)
    {
        ...
        $datosRequestPortalLog['detalle'] = "El usuario con el identificador N° $portalUserId trata de iniciar sessión";
        ...
        if (isset($existeInteresado) && $existeInteresado == true) {
            ...
            // Se inicializan los datos de la tabla
            $datosRequestPortalLog['portal_id_user'] = $portalUserId;
            $datosRequestPortalLog['detalle'] = "Se ha generado el código de acceso $token al usuario con el identificador N° $portalUserId.";
            $datosRequestPortalLog['informacion_equipo'] = json_encode($informacionEquipo);
            $datosRequestPortalLog['estado'] = true;
    ...
    public function destroy(Request $request)
    {
        ...
        // Se captura el id del usuario logeado
        $userId = $usuario->id;
        ...
        // Se inicializan los datos de la tabla
        $datosRequestPortalLog['portal_id_user'] = $userId;
        $datosRequestPortalLog['detalle'] = "El usuario con el identificador N° $userId ha cerrado la sessión.";
        $datosRequestPortalLog['informacion_equipo'] = json_encode($informacionEquipo);
        $datosRequestPortalLog['estado'] = true;
