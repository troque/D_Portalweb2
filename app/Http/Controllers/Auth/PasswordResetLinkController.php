        ...
        if (isset($existeUsuario) && $existeUsuario == 1) {
            ...
            if (isset($correoUsuario)) {
                ...
                if (isset($estado) && $estado == 1) {
                    ...
                    $asunto = "PORTAL WEB - REESTABLECER CONTRASEÑA";
                    $contenido = "PORTAL WEB - REESTABLECER CONTRASEÑA";
                    $archivos = null;
                    $correoscc = null;
                    $correosbbc = null;
                    $token = Str::random(90);
                    ...
                    // Se inicializan los datos de la tabla
                    $datosRequestPortalLog['portal_id_user'] = $usuarioId;
                    $datosRequestPortalLog['detalle'] = "Se ha generado el token: $token para generar una nueva contraseña al usuario con el identificador N° $usuarioId";
                    ...
                    return back()->withErrors(
                        [
                            'ok' => '200',
                            'msjRespuesta' => "Se ha enviado un link al correo electronico para reestablecer la contraseña.",
                        ]
                    );
                } else {
                    ...
                    return back()->withErrors(
                        [
                            'inactivo' => 'error',
                            'msjRespuesta' => "El usuario no ha activado la cuenta, por favor active la cuenta para poder reestablecer la contraseña.",
                        ]
                    );
                }
            } else {
