                        ...
                        <div class="p-6 bg-white border-b border-gray-200" style="text-align: center;">
                            ...
                            <div style="text-align: left;" class="mb-4">
                                ...
                                <div class="mt-4" style="margin-left: 30px;">
                                    <p class="mb-2" style="color: #939393;"><b style="color: #0374a6;">Radicado: </b> {{ isset($informacion->radicado) ? $informacion->radicado : '-' }} </p>
                                    ...
                                    <p class="mb-2" style="color: #939393;"><b style="color: #0374a6;">Vigencia: </b> {{ isset($informacion->vigencia) ? $informacion->vigencia : '-' }} </p>
                                            ...
                                            <tbody>
                                                @foreach ($informacionInteresados as $infInt)
                                                    <tr style="color: #939393;">
                                                        ...
                                                        <td>{{ $infInt->nombre_interesado }}</td>
                            ...
                            <div style="text-align: left;" class="mt-4">
                                            ...
                                            <tbody>
                                                @foreach ($informacionActuaciones as $infAct)
                                                    <tr style="color: #939393;">
                                                        ...
                                                        <td>{{ $infAct->auto }}</td>
                                                        <td>{{ $infAct->nombre_actuacion }}</td>
                                                        <td> <button>
                                                                <a href="process-details/' . {{ $infAct->documento_ruta }} . '"
                                                                    class="btn btn-sm"
                                ...
                                @elseif (isset($informacionDataActuaciones) && $informacionDataActuaciones == 0)
                                    <div style="text-align: left;  margin-top: 50px;" class="mb-3">
                                        <h3><b style="color: #939393;">No existe información de actuaciones en este proceso o no han sido aprobadas.</b></h3>
                                    </div>
                                @endif
                            </div>
